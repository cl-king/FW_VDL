...
//DD	#error "#include FreeRTOS.h" must appear in source files before "#include queue.h"
#endif
...
signed portBASE_TYPE xQueueReceive2( xQueueHandle pxQueue, void *pvBuffer, portTickType xTicksToWait );	
